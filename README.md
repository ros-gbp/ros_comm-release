## ros_comm (noetic) - 1.17.4-1

The packages in the `ros_comm` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic ros_comm` on `Mon, 19 May 2025 22:34:01 -0000`
...
- rosdistro version: `1.17.3-1`
- old version: `1.17.3-1`
- new version: `1.17.4-1`
...
## ros_comm (noetic) - 1.17.3-1

The packages in the `ros_comm` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic ros_comm` on `Sat, 10 May 2025 00:04:43 -0000`
...
- upstream repository: git@github.com:ros/ros_comm.git
- release repository: https://github.com/ros-gbp/ros_comm-release.git
- rosdistro version: `1.17.2-1`
- old version: `1.17.2-1`
- new version: `1.17.3-1`
...
## ros_comm (noetic) - 1.17.2-1

The packages in the `ros_comm` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic ros_comm` on `Fri, 02 May 2025 22:57:39 -0000`
...
## ros_comm (noetic) - 1.17.1-1

The packages in the `ros_comm` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic ros_comm` on `Sat, 26 Apr 2025 19:52:24 -0000`
...
## ros_comm (noetic) - 1.17.0-1

The packages in the `ros_comm` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic ros_comm --override-release-repository-push-url git@github.com:ros-gbp/ros_comm-release.git` on `Fri, 13 Sep 2024 17:46:51 -0000`
...
## ros_comm (noetic) - 1.16.0-1

The packages in the `ros_comm` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic ros_comm` on `Wed, 15 Feb 2023 14:12:32 -0000`
...
- upstream repository: git@github.com:ros/ros_comm.git
- release repository: https://github.com/ros-gbp/ros_comm-release.git
- rosdistro version: `1.15.15-1`
- old version: `1.15.15-1`
...
## ros_comm (noetic) - 1.15.15-1

The packages in the `ros_comm` repository were released into the `noetic` distro by running `/home/osrf/.local/bin/bloom-release -t noetic -r noetic ros_comm` on `Thu, 24 Nov 2022 01:08:02 -0000`
...
- upstream repository: git@github.com:ros/ros_comm.git
- release repository: https://github.com/ros-gbp/ros_comm-release.git
- rosdistro version: `1.15.14-1`
- old version: `1.15.14-1`
- new version: `1.15.15-1`
...
## ros_comm (melodic) - 1.14.13-1

The packages in the `ros_comm` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic ros_comm` on `Wed, 26 Jan 2022 01:52:24 -0000`
...
- upstream repository: git@github.com:ros/ros_comm.git
- release repository: https://github.com/ros-gbp/ros_comm-release.git
- rosdistro version: `1.14.12-1`
- old version: `1.14.12-1`
...
## ros_comm (noetic) - 1.15.14-1

The packages in the `ros_comm` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic ros_comm` on `Thu, 06 Jan 2022 19:31:42 -0000`
...
- upstream repository: git@github.com:ros/ros_comm.git
- release repository: https://github.com/ros-gbp/ros_comm-release.git
- rosdistro version: `1.15.13-1`
- old version: `1.15.13-1`
- new version: `1.15.14-1`
...
## ros_comm (noetic) - 1.15.13-1

The packages in the `ros_comm` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic ros_comm` on `Wed, 22 Sep 2021 17:14:50 -0000`
...
- upstream repository: git@github.com:ros/ros_comm.git
- release repository: https://github.com/ros-gbp/ros_comm-release.git
- rosdistro version: `1.15.12-1`
- old version: `1.15.12-1`
- new version: `1.15.13-1`
...
## ros_comm (noetic) - 1.15.12-1

The packages in the `ros_comm` repository were released into the `noetic` distro by running `/home/osrf/.local/bin/bloom-release --rosdistro noetic --track noetic ros_comm` on `Tue, 21 Sep 2021 17:50:23 -0000`
...
- upstream repository: git@github.com:ros/ros_comm.git
- release repository: https://github.com/ros-gbp/ros_comm-release.git
- rosdistro version: `1.15.11-1`
- old version: `1.15.11-1`
- new version: `1.15.12-1`
...
## ros_comm (melodic) - 1.14.12-1

The packages in the `ros_comm` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic ros_comm` on `Tue, 21 Sep 2021 17:38:48 -0000`
...
- upstream repository: git@github.com:ros/ros_comm.git
- release repository: https://github.com/ros-gbp/ros_comm-release.git
- rosdistro version: `1.14.11-1`
- old version: `1.14.11-1`
- new version: `1.14.12-1`
...
## ros_comm (melodic) - 1.14.11-1

The packages in the `ros_comm` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic ros_comm` on `Mon, 26 Apr 2021 20:09:48 -0000`
...
## ros_comm (noetic) - 1.15.11-1

The packages in the `ros_comm` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic ros_comm` on `Tue, 06 Apr 2021 18:46:01 -0000`
...
- upstream repository: git@github.com:ros/ros_comm.git
- release repository: https://github.com/ros-gbp/ros_comm-release.git
- rosdistro version: `1.15.10-1`
- old version: `1.15.10-1`
- new version: `1.15.11-1`
...
## ros_comm (noetic) - 1.15.10-1

The packages in the `ros_comm` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic ros_comm` on `Thu, 18 Mar 2021 21:19:29 -0000`
...
- upstream repository: git@github.com:ros/ros_comm.git
- release repository: https://github.com/ros-gbp/ros_comm-release.git
- rosdistro version: `1.15.9-1`
- old version: `1.15.9-1`
- new version: `1.15.10-1`
...
## ros_comm (kinetic) - 1.12.17-1

The packages in the `ros_comm` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -r kinetic ros_comm` on `Mon, 02 Nov 2020 18:04:55 -0000`
...
- upstream repository: git@github.com:ros/ros_comm.git
- release repository: https://github.com/ros-gbp/ros_comm-release.git
- rosdistro version: `1.12.16-1`
- old version: `1.12.16-1`
- new version: `1.12.17-1`
...
## ros_comm (melodic) - 1.14.10-1

The packages in the `ros_comm` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic ros_comm` on `Sat, 17 Oct 2020 00:28:39 -0000`
...
## ros_comm (noetic) - 1.15.9-1

The packages in the `ros_comm` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic --track noetic --override-release-repository-push-url git@github.com:ros-gbp/ros_comm-release.git ros_comm` on `Fri, 16 Oct 2020 20:19:51 -0000`
...
## ros_comm (kinetic) - 1.12.16-1

The packages in the `ros_comm` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -r kinetic -t kinetic ros_comm` on `Wed, 26 Aug 2020 23:23:05 -0000`
...
- upstream repository: git@github.com:ros/ros_comm.git
- release repository: https://github.com/ros-gbp/ros_comm-release.git
- rosdistro version: `1.12.15-1`
- old version: `1.12.15-1`
- new version: `1.12.16-1`
...
## ros_comm (melodic) - 1.14.9-1

The packages in the `ros_comm` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic ros_comm` on `Thu, 20 Aug 2020 19:52:44 -0000`
...
## ros_comm (melodic) - 1.14.8-1

The packages in the `ros_comm` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic ros_comm` on `Wed, 12 Aug 2020 15:52:18 -0000`
...
## ros_comm (noetic) - 1.15.8-1

The packages in the `ros_comm` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic ros_comm` on `Thu, 23 Jul 2020 22:49:45 -0000`
...
- upstream repository: git@github.com:ros/ros_comm.git
- release repository: https://github.com/ros-gbp/ros_comm-release.git
- rosdistro version: `1.15.7-1`
- old version: `1.15.7-1`
- new version: `1.15.8-1`
...
## ros_comm (melodic) - 1.14.6-1

The packages in the `ros_comm` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic ros_comm` on `Fri, 29 May 2020 19:35:00 -0000`
...
- upstream repository: git@github.com:ros/ros_comm.git
- release repository: https://github.com/ros-gbp/ros_comm-release.git
- rosdistro version: `1.15.5-1`
- old version: `1.15.5-1`
- new version: `1.15.6-1`
...
## ros_comm (noetic) - 1.15.5-1

The packages in the `ros_comm` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic ros_comm` on `Sat, 16 May 2020 05:11:04 -0000`
...
- upstream repository: git@github.com:ros/ros_comm.git
- release repository: https://github.com/ros-gbp/ros_comm-release.git
- rosdistro version: `1.15.4-1`
- old version: `1.15.4-1`
- new version: `1.15.5-1`
...
## ros_comm (melodic) - 1.14.5-1

The packages in the `ros_comm` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic ros_comm` on `Fri, 20 Mar 2020 03:53:49 -0000`
...
## ros_comm (noetic) - 1.15.4-1

The packages in the `ros_comm` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic ros_comm` on `Thu, 19 Mar 2020 23:11:26 -0000`
...
## ros_comm (indigo) - 1.11.3-0

The packages in the `ros_comm` repository were released into the `indigo` distro by running `/usr/bin/bloom-release -r indigo -t indigo ros_comm` on `Wed, 21 May 2014 17:20:28 -0000`
...
## ros_comm (indigo) - 1.11.2-0

The packages in the `ros_comm` repository were released into the `indigo` distro by running `/usr/bin/bloom-release -r indigo -t indigo ros_comm` on `Thu, 08 May 2014 21:18:13 -0000`
...
## ros_comm (indigo) - 1.11.1-0

The packages in the `ros_comm` repository were released into the `indigo` distro by running `/usr/bin/bloom-release -r indigo -t indigo ros_comm` on `Wed, 07 May 2014 22:05:39 -0000`
...
## ros_comm (indigo) - 1.11.0-1

User `dthomas@drudge` released the packages in the `ros_comm` repository into the `indigo` distro by running `/usr/bin/bloom-release -r indigo -t indigo ros_comm` on `Wed, 05 Mar 2014 03:20:34 -0000`
...
## ros_comm (indigo) - 1.11.0-0

User `dthomas@drudge` released the packages in the `ros_comm` repository into the `indigo` distro by running `/usr/bin/bloom-release -r indigo -t indigo ros_comm` on `Tue, 04 Mar 2014 19:51:53 -0000`
...
## ros_comm (hydro) - 1.10.2-0

User `dthomas@drudge` released the packages in the `ros_comm` repository into the `hydro` distro by running `/usr/bin/bloom-release -r hydro -t hydro ros_comm` on `Mon, 03 Mar 2014 23:05:31 -0000`
...
## ros_comm (hydro) - 1.10.1-0

User `dthomas@drudge` released the packages in the `ros_comm` repository into the `hydro` distro by running `/usr/bin/bloom-release -r hydro -t hydro ros_comm` on `Tue, 25 Feb 2014 23:47:18 -0000`
...
Version of package(s) in repository `ros_comm`:
- rosdistro version: `1.9.54-0`
- old version: `1.9.54-0`
...
## ros_comm (groovy) - 1.9.55-0

User `dthomas@drudge` released the packages in the `ros_comm` repository into the `groovy` distro by running `/usr/bin/bloom-release -r groovy -t groovy ros_comm` on `Tue, 25 Feb 2014 23:27:51 -0000`
...
- old version: `1.9.50-0`
- new version: `1.9.55-0`
...
Version of package(s) in repository `ros_comm`:
- rosdistro version: `1.9.53-0`
- old version: `1.9.53-0`
...
User `dthomas@drudge` released the packages in the `ros_comm` repository by running `/usr/bin/bloom-release -r hydro -t hydro ros_comm` on `Wed, 15 Jan 2014 01:36:45 -0000`
...
User `dthomas@drudge` released the packages in the `ros_comm` repository by running `/usr/bin/bloom-release -t hydro -r hydro ros_comm` on `Wed, 08 Jan 2014 15:58:59 -0000`
...
User `dthomas@drudge` released the packages in the `ros_comm` repository by running `/usr/bin/bloom-release -t hydro -r hydro ros_comm` on `Wed, 08 Jan 2014 06:44:31 -0000`
...
User `dthomas@drudge` released the packages in the `ros_comm` repository by running `/usr/bin/bloom-release -t hydro -r hydro ros_comm` on `Fri, 04 Oct 2013 08:48:53 -0000`
...
User `dthomas@drudge` released the packages in the `ros_comm` repository by running `/usr/bin/bloom-release -t groovy -r groovy ros_comm` on `Fri, 04 Oct 2013 08:27:44 -0000`
...
User `dthomas@drudge` released the packages in the `ros_comm` repository by running `/usr/bin/bloom-release -t groovy -r groovy ros_comm` on `Thu, 19 Sep 2013 00:46:01 -0000`
...
User `dthomas@drudge` released the packages in the `ros_comm` repository by running `/usr/bin/bloom-release -t hydro -r hydro ros_comm` on `Thu, 19 Sep 2013 00:23:57 -0000`
...
User `dthomas@drudge` released the packages in the `ros_comm` repository by running `/usr/bin/bloom-release -t groovy -r groovy ros_comm` on `Thu, 05 Sep 2013 22:30:57 -0000`
...
User `dthomas@drudge` released the packages in the `ros_comm` repository by running `/usr/bin/bloom-release -t hydro -r hydro ros_comm` on `Thu, 22 Aug 2013 04:51:17 -0000`
...
User `dthomas@drudge` released the packages in the `ros_comm` repository by running `/usr/bin/bloom-release --track groovy --ros-distro groovy ros_comm` on `Wed, 03 Jul 2013 20:55:08 -0000`
...
Version of package(s) in repository `ros_comm`:
- rosdistro version: `1.9.46-0`
- old version: `1.9.46-0`
...
User `dthomas@drudge` released the packages in the `ros_comm` repository by running `/usr/bin/bloom-release --track hydro --ros-distro hydro ros_comm` on `Wed, 03 Jul 2013 20:15:05 -0000`
